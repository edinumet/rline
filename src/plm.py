...
def plm(gs, datam, sites):
    ...
    ax3.text(0.1, 0.9, r's1 = %s $\mu g \ m^{-3}$' % '{0:.2f}'.format(sites[0]), fontsize=9,color='red')
    ax3.text(0.1, 0.8, r's2 = %s $\mu g \ m^{-3}$' % '{0:.2f}'.format(sites[1]), fontsize=9,color='green')
    ax3.text(0.1, 0.7, r's3 = %s $\mu g \ m^{-3}$' % '{0:.2f}'.format(sites[2]), fontsize=9,color='blue')
    ax3.text(0.1, 0.6, r's4 = %s $\mu g \ m^{-3}$' % '{0:.2f}'.format(sites[3]), fontsize=9,color='black')
